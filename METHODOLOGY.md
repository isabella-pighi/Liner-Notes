...
outside researchers, such as the CTU-13 botnet captures (García, Grill, Stiborek
& Zunino, 2014) and the CICIDS2017 traffic (Sharafaldin, Habibi Lashkari &
Ghorbani, 2018) against which the detector is benchmarked, sit a rung higher. Higher still is a finding that an
...
values would otherwise define the scale for everyone; the 1.4826 factor is
the standard normal-consistency constant (1/Φ⁻¹(0.75)) that rescales the MAD to
estimate the standard deviation under normality; the MAD estimator itself is due
to Hampel (1974), and Rousseeuw and Croux (1993) survey it alongside more robust
alternatives. The score threshold is found
...
high and one-sided, are the classic near-star outliers of the graph-anomaly
...
One caveat travels with the evidence, in keeping with the methodology's own rule
about naming the tier. The CICIDS2017 capture, one of the two externally
labelled botnet captures the detector is benchmarked against, has documented
label and feature-extraction issues in its original release (Engelen, Rimmer &
Joosen, 2021; Rosay, Cheval, Carlier & Leroux, 2022). Results measured against
it are read accordingly, and the CTU-13 captures (CC-BY licensed) carry the
weight where the two disagree.
...
3. Engelen, G., Rimmer, V., & Joosen, W. (2021). Troubleshooting an
   intrusion detection dataset: The CICIDS2017 case study. In *2021 IEEE
   Security and Privacy Workshops (SPW)*, pp. 7–12. IEEE.
...
5. García, S., Grill, M., Stiborek, J., & Zunino, A. (2014). An empirical
   comparison of botnet detection methods. *Computers & Security*, 45,
   100–123. doi:10.1016/j.cose.2014.05.011
6. Gu, G., Perdisci, R., Zhang, J., & Lee, W. (2008). BotMiner: Clustering
...
7. Hampel, F. R. (1974). The influence curve and its role in robust
   estimation. *Journal of the American Statistical Association*, 69(346),
   383–393. doi:10.1080/01621459.1974.10482962
8. Hariri, S., Carrasco Kind, M., & Brunner, R. J. (2021). Extended isolation
   forest. *IEEE Transactions on Knowledge and Data Engineering*, 33(4),
   1479–1489. doi:10.1109/TKDE.2019.2947676
9. Humble, J., & Farley, D. (2010). *Continuous Delivery: Reliable Software
   Releases through Build, Test, and Deployment Automation*. Addison-Wesley.
10. Liu, F. T., Ting, K. M., & Zhou, Z.-H. (2008). Isolation forest. In
   *Proceedings of the Eighth IEEE International Conference on Data Mining
   (ICDM 2008)*, pp. 413–422. IEEE. doi:10.1109/ICDM.2008.17
11. Rosay, A., Cheval, E., Carlier, F., & Leroux, P. (2022). Network
   intrusion detection: A comprehensive analysis of CIC-IDS2017. In
   *Proceedings of the 8th International Conference on Information Systems
   Security and Privacy (ICISSP 2022)*, pp. 25–36. SciTePress.
   doi:10.5220/0010774000003120
12. Rousseeuw, P. J., & Croux, C. (1993). Alternatives to the median absolute
   deviation. *Journal of the American Statistical Association*, 88(424),
   1273–1283. doi:10.1080/01621459.1993.10476408
13. Satopää, V., Albrecht, J., Irwin, D., & Raghavan, B. (2011). Finding a
...
14. Shannon, C. E. (1948). A mathematical theory of communication. *Bell
   System Technical Journal*, 27(3), 379–423.
   doi:10.1002/j.1538-7305.1948.tb01338.x
15. Sharafaldin, I., Habibi Lashkari, A., & Ghorbani, A. A. (2018). Toward
